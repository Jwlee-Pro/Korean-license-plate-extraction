...
if __name__ == "__main__":
    ...
    # See ./src/data/extract_LP_KeyCharacters.py
    #     opt.character = " 0123456789가강거경계고관광구금기김나남너노누다대더도동두등라러로루마머명모무문미바배버보부북사산서소수아악안양어연영오용우울원육인자작저전조주중지차천초추충카타파평포하허호홀제"
    # #         opt.character = " 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ가강거경계고관광구금기김나남너노누다대더도동두등라러로루마머명모무문미바배버보부북사산서소수아악안양어연영오용우울원육인자작저전조주중지차천초추충카타파평포하허호홀"
